...
# Homework
1. Fit a **multiple linear regression** using a dataset of your choice. Interpret coefficients.  
2. Read about **variable selection methods** in regression.  
3. Create your own **simulation** for polynomial regression.  
